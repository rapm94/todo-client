...
function Card({todo, deleteTodo, updateTodo}) {
        ...
        <div className='flex flex-col px-10 my-8'>
            <div className="bg-white p-6 shadow-md border border-gray-200 rounded-lg max-w-auto">
                    ...
                    <div className='flex gap-x-4'>
                        ...
                        <div>
                        <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-md">{todo.priority}</span>
                        <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-md">{todo.assigned}</span>
                        </div>
                    </div>
